...
Order of attempts:
1) from ManagementandControlService.app.main import app
2) from app.main import app
3) Adjust sys.path to include project root and retry absolute import
"""
...
# Try absolute import first: package-based
try:
    from ManagementandControlService.app.main import app  # type: ignore
except Exception:
    # Fallback 1: relative-style import when current dir is ManagementandControlService
    try:
        from app.main import app  # type: ignore
    except Exception:
        # Fallback 2: adjust sys.path to include parent directory (repo root)
        ...
        try:
            ...
            raise ImportError(
                ...
                "  1) from ManagementandControlService.app.main import app\n"
                "  2) from app.main import app\n"
                "  3) After sys.path fallback, from ManagementandControlService.app.main import app\n"
